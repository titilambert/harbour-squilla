...
from .config import is_favorite, get_favorites
from . import get_presence_auth_user, friend_list
#from .presence_browser import zeroconf
...
class Friend(Thread):
    def __init__(self, fullname, number, auth_user, zeroconf):
...
def add_friend(fullname, number, zeroconf):
    global friend_list
    ...
    if not number in number_list:
        ...
        new_friend = Friend(fullname, number, auth_user, zeroconf)
...
#def load_favorite_friends(zeroconf):
#    favorites = get_favorites()
#    for number, name in favorites:
#        if number and name:
#            add_friend(name, number, zeroconf)
